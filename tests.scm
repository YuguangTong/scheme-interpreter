...
(define a (cons 'car '('(1 2 3))))
; expect a
a
; expect (car (quote (1 2 3)))

;;; Q7

(begin (+ 5 10) (+ 5 7))
; expect 12
(begin (newline) (define a (* (+ 2 3) 5)) (define b (* 2 a)))
; expect b
b
; expect 50
...
(lambda (x) (define y (* 2 x)) (* y y))
; expect (lambda (x) (begin (define y (* 2 x)) (* y y)))

;;; Q9
(define f (lambda (x) (define y (* 2 x)) (* y y)))
; expect f
f
; expect (lambda (x) (begin (define y (* 2 x)) (* y y)))
...
(and 4 5 6 7)
; expect 7
(and 1 (or 5 #f (/ 1 0)) #f (/ 1 0))
; expect #f
(define a 3)
(and 1 4 (if #t (* a a) (/ 1 0)))
; expect 9
(or (if #t (* a a) (/ 1 0)) 4 1)
; expect 9
...
(define a 3)
(define b 4)
(cond ((if #t (* a a) (/ 1 0)) (begin (newline) (* a b)))
      (#t (/ a b))
      (else (/ 1 0)))
; expect 12
